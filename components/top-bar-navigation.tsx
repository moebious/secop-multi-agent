...
import { ChevronDown, Users, Building, FileText, LayoutDashboard } from "lucide-react"
...
export default function QuickActionsDropdown({ userRole = "administrator" }: QuickActionsDropdownProps) {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="neo-button-secondary text-sm sm:text-base px-4 sm:px-6">
          ACCIONES RÁPIDAS
